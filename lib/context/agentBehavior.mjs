...
export function buildFallbackChatMessages(request, errorMessage) {
  ...
  return [
    {
      role: 'system',
      content: 'You are Nexus Agent. A tool request failed, but you should still be helpful. Instead of a robotic error report, tell the user what happened in plain language and suggest the best way to move forward immediately.',
    },
    {
      role: 'user',
