...
const INDUSTRY_BEST_TIMES: Record<string, Record<Platform, TimeSlot[]>> = {
  'general': {
    ...
    discord: [
      { day: 3, hour: 18, score: 95, label: 'Wednesday 6 PM' },
      { day: 5, hour: 19, score: 92, label: 'Friday 7 PM' },
      { day: 6, hour: 17, score: 88, label: 'Saturday 5 PM' },
      { day: 1, hour: 19, score: 85, label: 'Monday 7 PM' },
      { day: 4, hour: 18, score: 82, label: 'Thursday 6 PM' },
    ],
    reddit: [
      { day: 2, hour: 9, score: 95, label: 'Tuesday 9 AM' },
      { day: 4, hour: 10, score: 92, label: 'Thursday 10 AM' },
      { day: 1, hour: 11, score: 88, label: 'Monday 11 AM' },
      { day: 3, hour: 9, score: 85, label: 'Wednesday 9 AM' },
      { day: 0, hour: 12, score: 82, label: 'Sunday 12 PM' },
    ],
    whatsapp: [
      { day: 3, hour: 19, score: 95, label: 'Wednesday 7 PM' },
      { day: 5, hour: 20, score: 92, label: 'Friday 8 PM' },
      { day: 6, hour: 19, score: 88, label: 'Saturday 7 PM' },
      { day: 1, hour: 18, score: 85, label: 'Monday 6 PM' },
      { day: 4, hour: 19, score: 82, label: 'Thursday 7 PM' },
    ],
    telegram: [
      { day: 3, hour: 18, score: 95, label: 'Wednesday 6 PM' },
      { day: 5, hour: 19, score: 92, label: 'Friday 7 PM' },
      { day: 6, hour: 18, score: 88, label: 'Saturday 6 PM' },
      { day: 1, hour: 18, score: 85, label: 'Monday 6 PM' },
      { day: 4, hour: 18, score: 82, label: 'Thursday 6 PM' },
    ],
    snapchat: [
      { day: 5, hour: 20, score: 95, label: 'Friday 8 PM' },
      { day: 6, hour: 21, score: 92, label: 'Saturday 9 PM' },
      { day: 0, hour: 19, score: 88, label: 'Sunday 7 PM' },
      { day: 3, hour: 19, score: 85, label: 'Wednesday 7 PM' },
      { day: 1, hour: 18, score: 82, label: 'Monday 6 PM' },
    ],
    general: [
      { day: 3, hour: 10, score: 95, label: 'Wednesday 10 AM' },
      { day: 4, hour: 14, score: 92, label: 'Thursday 2 PM' },
      { day: 2, hour: 11, score: 88, label: 'Tuesday 11 AM' },
  ...
  'b2b': {
    ...
    discord: [
      { day: 2, hour: 9, score: 90, label: 'Tuesday 9 AM' },
      { day: 3, hour: 10, score: 85, label: 'Wednesday 10 AM' },
      { day: 4, hour: 9, score: 80, label: 'Thursday 9 AM' },
      { day: 1, hour: 10, score: 78, label: 'Monday 10 AM' },
      { day: 5, hour: 9, score: 75, label: 'Friday 9 AM' },
    ],
    reddit: [
    ...
    whatsapp: [
      { day: 3, hour: 18, score: 88, label: 'Wednesday 6 PM' },
      { day: 5, hour: 19, score: 85, label: 'Friday 7 PM' },
      { day: 4, hour: 18, score: 80, label: 'Thursday 6 PM' },
      { day: 1, hour: 18, score: 78, label: 'Monday 6 PM' },
      { day: 0, hour: 12, score: 75, label: 'Sunday 12 PM' },
    ],
    telegram: [
      { day: 2, hour: 10, score: 85, label: 'Tuesday 10 AM' },
      { day: 3, hour: 11, score: 82, label: 'Wednesday 11 AM' },
      { day: 4, hour: 10, score: 80, label: 'Thursday 10 AM' },
      { day: 1, hour: 10, score: 78, label: 'Monday 10 AM' },
      { day: 5, hour: 9, score: 75, label: 'Friday 9 AM' },
    ...
    snapchat: [
      { day: 5, hour: 19, score: 85, label: 'Friday 7 PM' },
      { day: 6, hour: 20, score: 82, label: 'Saturday 8 PM' },
      { day: 0, hour: 18, score: 80, label: 'Sunday 6 PM' },
      { day: 3, hour: 18, score: 78, label: 'Wednesday 6 PM' },
      { day: 1, hour: 17, score: 75, label: 'Monday 5 PM' },
    ],
    general: [
      { day: 2, hour: 10, score: 90, label: 'Tuesday 10 AM' },
      { day: 3, hour: 11, score: 88, label: 'Wednesday 11 AM' },
